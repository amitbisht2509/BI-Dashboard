...
1. Push the `dashboard-portal` folder contents to a GitHub repository.
2. Repository Settings → Pages → set source to your main branch (root, or
   `/dashboard-portal` if it's a subfolder).
3. GitHub gives you a URL like `https://yourorg.github.io/dashboard-portal/`.
